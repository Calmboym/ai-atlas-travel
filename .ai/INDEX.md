...
- **Docs:** 03 Design System, 14 Design Tokens (all 6 parts — but pull only the relevant Part per task, not the whole document; see Audit Finding 10), 04 Component Inventory
